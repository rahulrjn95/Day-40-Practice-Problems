...
let firstContact = new Contact("Rahul", "Ranjan","#6ac812", "Ranchi", "Jharkhand", "123006", "4785961235", "rah007@gmail.com");
let secondContact = new Contact("Devansh", "Kumar","#3ac812", "Deoghar", "Jharkhand", "874596", "7894561238", "dev2022@gmail.com");
let thirdContact = new Contact("Jitu", "Sen", "#10c1", "Delhi", "Delhi", "857412", "6522948585", "jitu854@gmail.com");
let fourthContact = new Contact("Jacklin", "Farady", "#8105bc", "Lucknow", "Uttarpardesh", "834001", "9465837465", "jacklin52@gmail.com");
...
console.log("\nSearch Devansh In City - Deoghar");
console.log(searchContactByCity("Devansh", "Deoghar"));

console.log("\nSearch Devansh In State - Jharkhand");
console.log(searchContactByState("Devansh", "Jharkhand"));
...
console.log(viewContactsByState("Uttarpradesha"));